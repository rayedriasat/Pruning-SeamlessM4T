...
## Quick Reference: What to Delete and Replace

### 🗑️ DELETE These Sections (Find and Remove)

Search for these markdown headers and delete all cells until the next phase:

1. **"## Phase 4: Text Decoder Removal + CIF Connector + Speaker Adapter"**
   - Delete this markdown cell
   - Delete all code cells until Phase 5

2. **"## Phase 5: KD Target Extraction from Teacher"**
   - Delete this markdown cell
   - Delete all code cells until Phase 6

3. **"## Phase 6a: CIF Connector + Speaker Adapter Feature KD Training"**
   - Delete this markdown cell
   - Delete all code cells until Phase 6b

4. **"## Phase 6b: End-to-End Fine-tuning with DoRA"**
   - Delete this markdown cell
   - Delete all code cells until Phase 7

### ✅ INSERT These New Sections

After deleting old Phase 4-6, insert these new cells in order:
...
### Cell 4: Code - Benchmark and Plot
```python
...
Find the Phase 7 section and update the model loading line:

### Change This:
```python
model_final = load_textless_model_from_drive('phase6b_textless')
```
...
Also remove any textless-specific inference functions (like `run_textless_s2st`) and use the standard `run_s2st` function instead.

---

## Checklist

- [ ] Delete old Phase 4 markdown + all code cells
- [ ] Delete old Phase 5 markdown + all code cells
- [ ] Delete old Phase 6a markdown + all code cells
- [ ] Delete old Phase 6b markdown + all code cells
- [ ] Insert new Phase 4 cells (4 cells total)
- [ ] Insert new Phase 5 cells (4 cells total)
- [ ] Insert new Phase 6 cells (4 cells total)
- [ ] Update Phase 7 model loading
- [ ] Save notebook
- [ ] Test by running Phase 3 → Phase 4 → Phase 5 → Phase 6 → Phase 7

## Done!

Your notebook is now restructured for the new pruning approach.
