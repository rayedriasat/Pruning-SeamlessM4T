#!/usr/bin/env python3
"""
Fix Phase 5 Cell 2 - v2: Fix stats tensors device placement
The stats dictionary tensors must be on the same device as the model.
"""
...
# The new calibration function code with device-aware stats
new_code = '''# ── Phase 5 Cell 2: FIXED calibration with device-aware stats ──────────
...
print("Calibration helpers ready (FIXED: device-aware stats tensors).")'''
...
print("✓ Phase 5 Cell 2 updated successfully (v2)")
print("FIXES:")
print("  1. Stats tensors (sum_x, sq_sum) now created on device")
print("  2. All processor outputs moved to device")
print("  3. Final stats moved to CPU for processing")
