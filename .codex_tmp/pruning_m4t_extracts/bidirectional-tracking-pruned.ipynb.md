# mission500m\bidirectional-tracking-pruned.ipynb
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 2.3/2.3 MB 35.3 MB/s eta 0:00:00
   ...
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 788.2/788.2 kB 45.8 MB/s eta 0:00:00
...
```text
============================================================
  Platform : kaggle   Time : 2026-04-19 18:03
...
print("\n" + "="*80)
print("  BIDIRECTIONAL TRANSLATION & LAYER ANALYSIS")
print("="*80)

# Load the final model for analysis
model_analysis = model_p7_merged
model_analysis.eval()
...
```text
================================================================================
  BIDIRECTIONAL TRANSLATION & LAYER ANALYSIS
================================================================================
...
Registered 38 activation hooks
```

### Cell 34 (code, score=83)
```python
# ===============================================================================
...
Analyzing EN→BN translation...
  [ 1/10] BLEU= 14.8 ChrF= 49.4
  [ 2/10] BLEU=  6.2 ChrF= 39.5
  [ 3/10] BLEU= 10.8 ChrF= 45.4
  [ 4/10] BLEU=  6.2 ChrF= 46.2
  [ 5/10] BLEU=  8.8 ChrF= 48.0
  [ 6/10] BLEU=  8.5 ChrF= 40.3
  [ 7/10] BLEU=  6.8 ChrF= 38.7
  [ 8/10] BLEU=  7.5 ChrF= 51.9
  [ 9/10] BLEU= 12.6 ChrF= 51.1
  [10/10] BLEU= 12.1 ChrF= 57.7
...
Analyzing BN→EN translation...
  [ 1/10] BLEU=  4.5 ChrF= 35.3
  [ 2/10] BLEU=  0.0 ChrF=  0.0
  [ 3/10] BLEU=  6.4 ChrF= 29.4
  [ 4/10] BLEU= 11.4 ChrF= 41.5
  [ 5/10] BLEU=  0.0 ChrF=  0.0
  [ 6/10] BLEU=  0.0 ChrF=  0.0
  [ 7/10] BLEU=  0.0 ChrF=  0.0
  [ 8/10] BLEU=  0.0 ChrF=  0.0
  [ 9/10] BLEU=  0.0 ChrF=  0.0
  [10/10] BLEU=  5.8 ChrF= 34.8
```

### Cell 35 (code, score=135)
```python
# ===============================================================================
...
TEXT_DECODER Layers (ranked by importance):
   1. Layer 12: 4839.4907
   2. Layer 11: 4681.0497
   3. Layer 10: 4379.9317
   4. Layer 13: 4259.0497
   5. Layer  9: 3973.3975
   6. Layer  8: 3428.9689
   7. Layer  7: 2818.7609
   8. Layer  6: 2416.4441
   9. Layer  5: 2089.9720
  10. Layer  4: 1804.6832
  11. Layer  3: 1485.6491
  12. Layer  2: 1205.7857
  13. Layer  1: 955.5823
  14. Layer  0: 678.3424
...
TEXT_DECODER Layers (ranked by importance):
   1. Layer 12: 5245.6124
   2. Layer 13: 4815.5969
   3. Layer 11: 4814.8372
   4. Layer 10: 4390.4031
   5. Layer  9: 3897.2558
   6. Layer  8: 3318.9922
   7. Layer  7: 2883.7752
   8. Layer  6: 2542.4031
   9. Layer  5: 2268.6357
  10. Layer  4: 1992.8217
  11. Layer  3: 1728.5039
  12. Layer  2: 1489.8915
  13. Layer  1: 1235.0969
  14. Layer  0: 909.7229
...
-------------------------------------------------------
0        61.2281         64.6125         -3.3844     
1        60.1969         58.5781         1.6187      
2        78.1125         76.2062         1.9062      
3        194.6250        187.0625        7.5625      

Most Direction-Specific Layers in T2U_ENCODER:
  Layer  3: More important for EN→BN (diff: 7.5625)
  Layer  0: More important for BN→EN (diff: 3.3844)
  Layer  2: More important for EN→BN (diff: 1.9062)
  Layer  1: More important for EN→BN (diff: 1.6187)

TEXT_DECODER - Direction Comparison:
Layer    EN→BN           BN→EN           Difference  
-------------------------------------------------------
0        678.3424        909.7229        -231.3805   
1        955.5823        1235.0969       -279.5146   
2        1205.7857       1489.8915       -284.1058   
3        1485.6491       1728.5039       -242.8548   
4        1804.6832       1992.8217       -188.1385   
5        2089.9720       2268.6357       -178.6636   
6        2416.4441       2542.4031       -125.9590   
7        2818.7609       2883.7752       -65.0143    
8        3428.9689       3318.9922       109.9767    
9        3973.3975       3897.2558       76.1417     
10       4379.9317       4390.4031       -10.4714    
11       4681.0497       4814.8372       -133.7875   
12       4839.4907       5245.6124       -406.1217   
13       4259.0497       4815.5969       -556.5472   

Most Direction-Specific Layers in TEXT_DECODER:
  Layer 13: More important for BN→EN (diff: 556.5472)
  Layer 12: More important for BN→EN (diff: 406.1217)
  Layer  2: More important for BN→EN (diff: 284.1058)
  Layer  1: More important for BN→EN (diff: 279.5146)
  Layer  3: More important for BN→EN (diff: 242.8548)

T2U_DECODER - Direction Comparison:
Layer    EN→BN           BN→EN           Difference  
-------------------------------------------------------
0        31.4812         31.4344         0.0469      
1        31.8906         31.9969         -0.1062     
2        37.8937         37.5156         0.3781      
3        31.5891         31.1609         0.4281      

Most Direction-Specific Layers in T2U_DECODER:
  Layer  3: More important for EN→BN (diff: 0.4281)
  Layer  2: More important for EN→BN (diff: 0.3781)
  Layer  1: More important for BN→EN (diff: 0.1062)
  Layer  0: More important for EN→BN (diff: 0.0469)
...
2        20.9812         21.4266         -0.4453     
3        24.5031         24.6625         -0.1594     
4        20.1859         20.4406         -0.2547     
5        8.6344          8.5906          0.0438      
6        22.0188         21.3813         0.6375      
7        25.2203         24.6438         0.5766      
8        21.3531         21.0297         0.3234      
9        19.7344         19.3156         0.4187      
10       20.8000         21.0906         -0.2906     
11       19.5531         19.9281         -0.3750     
12       15.7672         16.1172         -0.3500     
13       13.3352         13.7352         -0.4000     
14       12.2141         12.4109         -0.1969     
15       5.2383          5.1914          0.0469      

Most Direction-Specific Layers in SPEECH_ENCODER:
  Layer  6: More important for EN→BN (diff: 0.6375)
  Layer  7: More important for EN→BN (diff: 0.5766)
  Layer  2: More important for BN→EN (diff: 0.4453)
  Layer  9: More important for EN→BN (diff: 0.4187)
  Layer 13: More important for BN→EN (diff: 0.4000)
```

### Cell 37 (code, score=47)
```python
# ===============================================================================
# SUMMARY STATISTICS
# ===============================================================================
